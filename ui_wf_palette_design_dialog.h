...
public:
    ...
    void setupUi(QDialog *wf_palette_design_dialog)
    {
        if (wf_palette_design_dialog->objectName().isEmpty())
            wf_palette_design_dialog->setObjectName(QStringLiteral("wf_palette_design_dialog"));
        ...
        colour_table_widget->setObjectName(QStringLiteral("colour_table_widget"));
    ...
    {
        wf_palette_design_dialog->setWindowTitle(QApplication::translate("wf_palette_design_dialog", "Palette Designer", nullptr));
#ifndef QT_NO_TOOLTIP
        colour_table_widget->setToolTip(QApplication::translate("wf_palette_design_dialog", "<html><head/><body><p>Double click a color to edit it.</p><p>Right click to insert or delete colors.</p><p>Colors at the top represent weak signals</p><p>and colors at the bottom represent strong</p><p>signals. You can have up to 256 colors.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
