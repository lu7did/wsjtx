...
void FrequencyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        FrequencyLineEdit *_t = static_cast<FrequencyLineEdit *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FrequencyLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_FrequencyLineEdit.data,
      qt_meta_data_FrequencyLineEdit,  qt_static_metacall, nullptr, nullptr}
};
