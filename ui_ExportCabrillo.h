...
public:
    ...
    void setupUi(QDialog *ExportCabrillo)
    {
        ...
        contest_label->setObjectName(QStringLiteral("contest_label"));

        formLayout->setWidget(1, QFormLayout::LabelRole, contest_label);

        contest_line_edit = new QLineEdit(ExportCabrillo);
        contest_line_edit->setObjectName(QStringLiteral("contest_line_edit"));
        ...
        call_line_edit->setObjectName(QStringLiteral("call_line_edit"));
        ...
        category_op_label->setObjectName(QStringLiteral("category_op_label"));

        formLayout->setWidget(3, QFormLayout::LabelRole, category_op_label);

        category_op_line_edit = new QLineEdit(ExportCabrillo);
        category_op_line_edit->setObjectName(QStringLiteral("category_op_line_edit"));
        ...
        category_xmtr_label->setObjectName(QStringLiteral("category_xmtr_label"));

        formLayout->setWidget(4, QFormLayout::LabelRole, category_xmtr_label);

        category_xmtr_line_edit = new QLineEdit(ExportCabrillo);
        category_xmtr_line_edit->setObjectName(QStringLiteral("category_xmtr_line_edit"));
        ...
        category_pwr_label->setObjectName(QStringLiteral("category_pwr_label"));

        formLayout->setWidget(5, QFormLayout::LabelRole, category_pwr_label);

        category_pwr_line_edit = new QLineEdit(ExportCabrillo);
        category_pwr_line_edit->setObjectName(QStringLiteral("category_pwr_line_edit"));
        ...
        category_assisted_label->setObjectName(QStringLiteral("category_assisted_label"));
        ...
        category_assisted_line_edit->setObjectName(QStringLiteral("category_assisted_line_edit"));
        ...
        category_band_label->setObjectName(QStringLiteral("category_band_label"));

        formLayout->setWidget(7, QFormLayout::LabelRole, category_band_label);

        category_band_line_edit = new QLineEdit(ExportCabrillo);
        category_band_line_edit->setObjectName(QStringLiteral("category_band_line_edit"));
        ...
        claimed_label->setObjectName(QStringLiteral("claimed_label"));

        formLayout->setWidget(8, QFormLayout::LabelRole, claimed_label);

        claimed_line_edit = new QLineEdit(ExportCabrillo);
        claimed_line_edit->setObjectName(QStringLiteral("claimed_line_edit"));
        ...
        operators_label->setObjectName(QStringLiteral("operators_label"));

        formLayout->setWidget(9, QFormLayout::LabelRole, operators_label);

        operators_line_edit = new QLineEdit(ExportCabrillo);
        operators_line_edit->setObjectName(QStringLiteral("operators_line_edit"));
        ...
        club_label->setObjectName(QStringLiteral("club_label"));

        formLayout->setWidget(10, QFormLayout::LabelRole, club_label);

        club_line_edit = new QLineEdit(ExportCabrillo);
        club_line_edit->setObjectName(QStringLiteral("club_line_edit"));
        ...
        addr_1_label->setObjectName(QStringLiteral("addr_1_label"));

        formLayout->setWidget(12, QFormLayout::LabelRole, addr_1_label);

        addr_1_line_edit = new QLineEdit(ExportCabrillo);
        addr_1_line_edit->setObjectName(QStringLiteral("addr_1_line_edit"));
        ...
        addr_2_label->setObjectName(QStringLiteral("addr_2_label"));

        formLayout->setWidget(13, QFormLayout::LabelRole, addr_2_label);

        addr_2_line_edit = new QLineEdit(ExportCabrillo);
        addr_2_line_edit->setObjectName(QStringLiteral("addr_2_line_edit"));
    ...
    {
        ExportCabrillo->setWindowTitle(QApplication::translate("ExportCabrillo", "Dialog", nullptr));
        location_label->setText(QApplication::translate("ExportCabrillo", "Location:", nullptr));
        location_line_edit->setText(QApplication::translate("ExportCabrillo", "SNJ", nullptr));
        contest_label->setText(QApplication::translate("ExportCabrillo", "Contest:", nullptr));
        contest_line_edit->setText(QApplication::translate("ExportCabrillo", "ARRL-RTTY", nullptr));
        call_label->setText(QApplication::translate("ExportCabrillo", "Callsign:", nullptr));
        call_line_edit->setText(QString());
        category_op_label->setText(QApplication::translate("ExportCabrillo", "Category-Operator: ", nullptr));
        category_op_line_edit->setText(QApplication::translate("ExportCabrillo", "SINGLE-OP", nullptr));
        category_xmtr_label->setText(QApplication::translate("ExportCabrillo", "Category-Transmitter:", nullptr));
        category_xmtr_line_edit->setText(QApplication::translate("ExportCabrillo", "ONE", nullptr));
        category_pwr_label->setText(QApplication::translate("ExportCabrillo", "Category-Power:", nullptr));
        category_pwr_line_edit->setText(QApplication::translate("ExportCabrillo", "LOW", nullptr));
        category_assisted_label->setText(QApplication::translate("ExportCabrillo", "Category-Assisted:", nullptr));
        category_assisted_line_edit->setText(QApplication::translate("ExportCabrillo", "NON-ASSISTED", nullptr));
        category_band_label->setText(QApplication::translate("ExportCabrillo", "Category-Band:", nullptr));
        category_band_line_edit->setText(QApplication::translate("ExportCabrillo", "ALL", nullptr));
        claimed_label->setText(QApplication::translate("ExportCabrillo", "Claimed-Score:", nullptr));
        claimed_line_edit->setText(QString());
        operators_label->setText(QApplication::translate("ExportCabrillo", "Operators:", nullptr));
        operators_line_edit->setText(QString());
        club_label->setText(QApplication::translate("ExportCabrillo", "Club:", nullptr));
        name_label->setText(QApplication::translate("ExportCabrillo", "Name:", nullptr));
        name_line_edit->setText(QString());
        addr_1_label->setText(QApplication::translate("ExportCabrillo", "Address:", nullptr));
        addr_2_label->setText(QApplication::translate("ExportCabrillo", "Address:", nullptr));
    } // retranslateUi
