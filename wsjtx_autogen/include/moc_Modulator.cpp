...
void Modulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Modulator *_t = static_cast<Modulator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Modulator::staticMetaObject = {
    { &AudioDevice::staticMetaObject, qt_meta_stringdata_Modulator.data,
      qt_meta_data_Modulator,  qt_static_metacall, nullptr, nullptr}
};
